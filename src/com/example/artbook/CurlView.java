...
public class CurlView extends GLSurfaceView implements View.OnTouchListener,
    ...
    public void onPageSizeChanged(int width, int height) {
        Log.d("artbook",">>>>>on page size changed, "+Thread.currentThread());
    ...
    @Override
    public void onSizeChanged(final int w,final int h, int ow, int oh) {
...
//        requestRender();
    ...
    public void setPageProvider(PageProvider pageProvider) {
        Log.d("artbook",">>>>>set page provider "+Thread.currentThread());
    ...
    private void updatePage(CurlPage page, int index) {
        Log.d("artbook",">>>>>update page: "+Thread.currentThread());
